...
df_metrics_GRN <- data.frame(GRN_n_BiomarkerIncluded=num_biomarkersGRNIncluded,GRN_n_regulators=num_regulators,GRN_n_components=num_components,GRN_Degree=avg_dgs,GRN_pairwise_distance=avg_dts,GRN_betweenness_centrality=avg_bet,GRN_closeness_centrality=avg_clo)
